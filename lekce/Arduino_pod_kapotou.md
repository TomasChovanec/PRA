...
Je důležité si uvědomit, že číslo pinu na desce Arduina je jen mapování – skutečné ovládání se vždy děje přes konkrétní port a jeho bit v registrech mikrokontroléru.
