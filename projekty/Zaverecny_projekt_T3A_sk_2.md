...
## 2. Monitor teploty pacienta Ivan R. Radim P. :heavy_check_mark: :heavy_check_mark:
...
## 3. RFID přístup do místnosti Jiří S., Petr M. :heavy_check_mark: :heavy_check_mark:
...
## 4. Osvětlení pokoje (Bluetooth) Denis M., Marek O. :heavy_check_mark: :heavy_check_mark:
...
## 5. Transport jídla (robot) Libor R. Lukáš M. :heavy_check_mark: :heavy_check_mark:
...
## 7. Řídící jednotka včetně webového rozhraní Tomáš M. Jan S. :heavy_check_mark: :heavy_check_mark:
