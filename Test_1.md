...
- Vytvořte vlatní funkci ```void blinkRed()```. Ta po zavolání jednou blikne příslušnou barvou RGB LEDky (500ms ON, 500ms OFF). Hint: [Definice vlastní funkce](/lekce/Definice_funkce.md)
